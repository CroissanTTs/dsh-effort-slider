...
.dsh-rsi-dot{width:8px;height:8px;border-radius:50%;background:var(--dsw-alias-brand-primary);flex:none;transition:background .25s}
...
.dsh-rs-fill{position:absolute;left:0;top:0;bottom:0;border-radius:999px;background:var(--dsw-alias-brand-primary);transition:width .15s ease,background .25s ease}
.dsh-rs-fill[data-level="xhigh"]{background:linear-gradient(90deg,var(--dsw-alias-brand-primary),var(--dsw-alias-state-accent,var(--dsw-alias-brand-primary)))}
.dsh-rs-fill[data-level="max"]{background:linear-gradient(90deg,var(--dsw-alias-brand-primary),var(--dsw-alias-state-accent,var(--dsw-alias-brand-primary)),var(--dsw-alias-brand-primary));background-size:200% 100%;animation:dsh-rs-shimmer 1.8s linear infinite}
...
.dsh-rs-dot.active{background:var(--dsw-alias-brand-primary-invert,var(--dsw-alias-bg-module-platform))}
.dsh-rs-thumb{position:absolute;left:0;top:50%;width:14px;height:14px;border-radius:50%;background:var(--dsw-alias-brand-primary);box-shadow:0 1px 3px rgba(0,0,0,.3);transform:translate(-50%,-50%);transition:left .15s ease;pointer-events:none}
