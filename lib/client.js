...
.dsh-rs-fill{position:absolute;left:-2px;top:0;bottom:0;border-radius:999px;background:var(--dsw-alias-state-business-primary);transition:width .15s ease,background .25s ease}
