...
.dsh-rs-track{position:relative;width:168px;flex:none;height:18px;border-radius:999px;background:var(--dsw-alias-border-l2);overflow:hidden}
.dsh-rs-range{position:absolute;left:6px;right:6px;top:0;bottom:0}
...
.dsh-rs-thumb{position:absolute;left:0;top:50%;width:12px;height:12px;border-radius:50%;background:var(--dsw-alias-bg-module-platform);box-shadow:0 0 0 2px var(--dsw-alias-label-primary),0 1px 2px rgba(0,0,0,.25);transform:translate(-50%,-50%);transition:left .15s ease;pointer-events:none}
