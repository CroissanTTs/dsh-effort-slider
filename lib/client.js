...
.dsh-rsi-dot[data-level="xhigh"]{background:var(--dsw-alias-state-business-primary)}
.dsh-rsi-dot[data-level="max"]{background:var(--dsw-alias-state-business-primary)}
			...
			return jsxs("div", { className: "dsh-rsi", ref, children: [
				...
				open && jsxs("div", { className: "dsh-rsi-pop", children: [
					jsxs("div", { className: "dsh-rsi-popHeader", children: [
						...
						jsx("span", { className: "dsh-rsi-popValue", children: label })
					]}),
