...
.dsh-rs-thumb{position:absolute;left:0;top:50%;width:14px;height:14px;border-radius:50%;background:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 2.5px var(--dsw-alias-bg-module-platform),0 1px 3px rgba(0,0,0,.25);transform:translate(-50%,-50%);transition:left .15s ease;pointer-events:none}
				...
				open && jsxs("div", { className: "dsh-rsi-pop", children: [
					...
					jsxs("div", { className: "dsh-rs-track", children: [
						jsxs("div", { className: "dsh-rs-range", children: [
							jsx("div", { className: "dsh-rs-fill", "data-level": fillLevel, style: { width: `calc(${pct}% + 9px)` } }),
