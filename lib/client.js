...
.dsh-rs-fill[data-level="max"]{background:radial-gradient(circle,rgba(255,255,255,.9) 1px,transparent 1.5px) 0 50%/32px 100% repeat-x,radial-gradient(circle,rgba(255,255,255,.5) .5px,transparent 1px) 16px 50%/32px 100% repeat-x,linear-gradient(90deg,#a855f7,#d946ef,#a855f7);background-size:32px 100%,32px 100%,200% 100%;animation:dsh-rs-stars 1.8s linear infinite}
@keyframes dsh-rs-stars{to{background-position:-32px 0,-32px 0,-200% 0}}
