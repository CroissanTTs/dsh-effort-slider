...
.dsh-rs-fill{position:absolute;left:-2px;top:0;bottom:0;border-radius:999px;background:color-mix(in srgb,var(--dsw-alias-state-business-primary) 22%,transparent);transition:width .15s ease}
