...
.dsh-rsi-labelWrap{width:100%;padding:0 7px}
.dsh-rsi-labelInner{position:relative;height:18px}
.dsh-rsi-level{position:absolute;top:0;transform:translateX(-50%);font-size:10px;color:var(--dsw-alias-label-tertiary);cursor:pointer;padding:2px 4px;border-radius:6px;white-space:nowrap;transition:color .12s,background .12s}
		...
		function ReasoningSlider({ store, select }) {
			...
			return jsxs("div", { className: "dsh-rsi", ref, children: [
				...
				open && jsxs("div", { className: "dsh-rsi-pop", children: [
					...
					jsx("div", { className: "dsh-rsi-labelWrap", children: [
						jsx("div", { className: "dsh-rsi-labelInner", children: levels.map((l, i) => {
