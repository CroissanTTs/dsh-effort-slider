...
.dsh-rs-track{position:relative;width:100%;flex:none;height:18px;border-radius:999px;background:var(--dsw-alias-border-l2);box-shadow:inset 0 1px 2px rgba(0,0,0,.1);overflow:hidden;touch-action:none}
.dsh-rs-range{position:absolute;left:9px;right:9px;top:0;bottom:0}
...
.dsh-rs-fill[data-level="max"]{background:linear-gradient(90deg,#a855f7,#d946ef,#a855f7);background-size:200% 100%;animation:dsh-rs-shimmer 1.8s linear infinite}
				...
				open && jsxs("div", { className: "dsh-rsi-pop", children: [
					...
					jsxs("div", { className: "dsh-rs-track", children: [
						jsxs("div", { className: "dsh-rs-range", children: [
							jsx("div", { className: "dsh-rs-fill", "data-level": fillLevel, style: { width: `calc(${pct}% + 11px)` } }),
